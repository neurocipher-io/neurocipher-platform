...
- `docs/architecture/Data-Pipeline-Architecture.md` and `docs/architecture/ARC-002-Data-Pipeline-Architecture-Blueprint.md` align with the decisions recorded here (no conflicting alternate baselines).
