...
Release readiness checks depend on the capacity/cost envelope recorded in `docs/observability/CAP-001-Capacity-and-Scalability-Model.md` (QPS, queue depth, Weaviate throughput).
