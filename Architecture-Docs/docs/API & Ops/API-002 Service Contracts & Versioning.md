...
Owner: Platform  
Scope: Neurocipher Pipeline and AuditHound public APIs. AWS only.  
Status: Final v1.0  
...
- For orchestration-level routing and execution boundaries, see ADR-011 §4.1–4.2. Justification: Ensures that any new service contract understands where orchestration logic resides (Agent Forge) and keeps inter-service design consistent.
