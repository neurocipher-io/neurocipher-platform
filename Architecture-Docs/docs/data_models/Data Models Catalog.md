...
If you want, I can add these to your repo structure under:

/docs/

data-models/

Domain Model Catalog.md

ERD and Storage Schemas.md

JSON Schemas Catalog.md

Event Models and Contracts.md

Data Contracts and Versioning.md